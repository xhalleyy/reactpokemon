    ...
    <div className='grid grid-cols-2 pt-10'>
      ...
      <div className='lg:col-span-1 col-span-2 flex justify-center lg:justify-end items-center'>
        ...
        <div className='bg-white rounded-md border-2 border-black'>
            <input type="text" placeholder="Enter a Pokémon" className='font-kodchasan-semi text-xl md:text-2xl lg:text-xl xl:text-3xl ps-1 xl:ps-2 text-gray-400 w-44 md:w-56 lg:w-44 xl:w-72 xl:h-10' />
        </div>
        <div className='cursor-pointer bg-yellow-200 border-2 border-black px-2 rounded-md mx-1 md:mx-3'>
